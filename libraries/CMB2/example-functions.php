...
function yourprefix_register_demo_metabox() {
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Text Small', 'zues-framework' ),
		'desc' => esc_html__( 'field description (optional)', 'zues-framework' ),
		'id'   => $prefix . 'textsmall',
		'type' => 'text_small',
		// 'repeatable' => true,
		// 'column' => array(
		// 	'name'     => esc_html__( 'Column Title', 'zues-framework' ), // Set the admin column title
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Text Medium', 'zues-framework' ),
		'desc' => esc_html__( 'field description (optional)', 'zues-framework' ),
	...
	$cmb_demo->add_field( array(
		'name'       => esc_html__( 'Read-only Disabled Field', 'zues-framework' ),
		'desc'       => esc_html__( 'field description (optional)', 'zues-framework' ),
		'id'         => $prefix . 'readonly',
		'type'       => 'text_medium',
		'default'    => esc_attr__( 'Hey there, I\'m a read-only field', 'zues-framework' ),
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Custom Rendered Field', 'zues-framework' ),
		'desc' => esc_html__( 'field description (optional)', 'zues-framework' ),
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Website URL', 'zues-framework' ),
		'desc' => esc_html__( 'field description (optional)', 'zues-framework' ),
		'id'   => $prefix . 'url',
		'type' => 'text_url',
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Text Email', 'zues-framework' ),
		'desc' => esc_html__( 'field description (optional)', 'zues-framework' ),
		'id'   => $prefix . 'email',
		'type' => 'text_email',
		// 'repeatable' => true,
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Time', 'zues-framework' ),
		'desc' => esc_html__( 'field description (optional)', 'zues-framework' ),
		'id'   => $prefix . 'time',
		'type' => 'text_time',
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Time zone', 'zues-framework' ),
		'desc' => esc_html__( 'Time zone', 'zues-framework' ),
		'id'   => $prefix . 'timezone',
		'type' => 'select_timezone',
	) );

	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Date Picker', 'zues-framework' ),
		'desc' => esc_html__( 'field description (optional)', 'zues-framework' ),
		'id'   => $prefix . 'textdate',
		'type' => 'text_date',
		// 'date_format' => 'Y-m-d',
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Date Picker (UNIX timestamp)', 'zues-framework' ),
		'desc' => esc_html__( 'field description (optional)', 'zues-framework' ),
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Date/Time Picker Combo (UNIX timestamp)', 'zues-framework' ),
		'desc' => esc_html__( 'field description (optional)', 'zues-framework' ),
	...
	// $cmb_demo->add_field( array(
	// 	'name' => esc_html__( 'Test Date/Time Picker/Time zone Combo (serialized DateTime object)', 'zues-framework' ),
	// 	'desc' => esc_html__( 'field description (optional)', 'zues-framework' ),
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Money', 'zues-framework' ),
		'desc' => esc_html__( 'field description (optional)', 'zues-framework' ),
		'id'   => $prefix . 'textmoney',
		'type' => 'text_money',
	...
	$cmb_demo->add_field( array(
		'name'    => esc_html__( 'Test Color Picker', 'zues-framework' ),
		'desc'    => esc_html__( 'field description (optional)', 'zues-framework' ),
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Text Area', 'zues-framework' ),
		'desc' => esc_html__( 'field description (optional)', 'zues-framework' ),
		'id'   => $prefix . 'textarea',
		'type' => 'textarea',
	) );
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Text Area Small', 'zues-framework' ),
		'desc' => esc_html__( 'field description (optional)', 'zues-framework' ),
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Text Area for Code', 'zues-framework' ),
		'desc' => esc_html__( 'field description (optional)', 'zues-framework' ),
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Title Weeeee', 'zues-framework' ),
		'desc' => esc_html__( 'This is a title description', 'zues-framework' ),
		'id'   => $prefix . 'title',
		'type' => 'title',
	) );

	$cmb_demo->add_field( array(
		'name'             => esc_html__( 'Test Select', 'zues-framework' ),
		'desc'             => esc_html__( 'field description (optional)', 'zues-framework' ),
		'id'               => $prefix . 'select',
		'type'             => 'select',
		'show_option_none' => true,
		'options'          => array(
			'standard' => esc_html__( 'Option One', 'zues-framework' ),
			'custom'   => esc_html__( 'Option Two', 'zues-framework' ),
			'none'     => esc_html__( 'Option Three', 'zues-framework' ),
		),
	) );
